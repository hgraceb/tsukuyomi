...
void expectList({int length = 0, List<int> visible = const []}) {
  final hidden = length == 0 ? const <int>{} : List.generate(length, (i) => i).toSet().difference(visible.toSet());
