...
class DebugListCaseAnchorDefault extends StatefulWidget {
  const DebugListCaseAnchorDefault({super.key});

  @override
  State<DebugListCaseAnchorDefault> createState() => _DebugListCaseAnchorDefaultState();
}

class _DebugListCaseAnchorDefaultState extends State<DebugListCaseAnchorDefault> {
  int step = 0;
