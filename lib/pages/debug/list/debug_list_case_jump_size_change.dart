...
class DebugListCaseJumpSizeChange extends StatefulWidget {
  const DebugListCaseJumpSizeChange({super.key});

  @override
  State<DebugListCaseJumpSizeChange> createState() => _DebugListCaseJumpSizeChangeState();
}

class _DebugListCaseJumpSizeChangeState extends State<DebugListCaseJumpSizeChange> {
  int step = 0;
